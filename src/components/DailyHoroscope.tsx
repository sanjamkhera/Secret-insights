...
//           <Card className="bg-gradient-to-br from-blue-950 via-indigo-950 to-purple-950 border-blue-800 text-white rounded-2xl transition-all duration-500 ease-in-out animate-fadeIn relative w-11/12 max-h-full overflow-auto">
//             <Button
...
const DailyHoroscope: React.FC<DailyHoroscopeProps> = ({ onSignSelect }) => {
  ...
  return (
    <Card className="bg-black bg-opacity-60 text-white shadow-lg font-sans border-black-400 border-2 max-w-sm mx-auto rounded-3xl overflow-hidden transition-all duration-300 ease-in-out transform">
      <CardHeader className="pb-2">
        <div className="text-center">
          <h1 className="text-3xl font-bold font-cursive leading-relaxed text-gray-200">Daily Horoscope</h1>
        </div>
      </CardHeader>
